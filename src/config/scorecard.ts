...
export const scorecard: Scorecard = {
  id: "scorecard-v1",
  title: "Scorecard V1",
  description: "Dastyare Social ScoreCard — Version 1",
  questions: [
    /* — 01 — */
    {
      id: 1,
    ...
    /* — 04 — */
    {
      ...
      options: [
        ...
        { label: "clear content journey mapped for the next quarter", score: 4 },
        {
    ...
    /* — 08 — */
    {
      ...
      options: [
        ...
        {
          label:
            "our process is followed every time and continuously improved",
          score: 5,
        },
      ],
    },
...
/* —— GLOBAL HIGHLIGHT WORDS —— */

export const HIGHLIGHT_WORDS: string[] = Array.from(
  new Set(scorecard.questions.flatMap((q) => q.highlightPhrases))
);
